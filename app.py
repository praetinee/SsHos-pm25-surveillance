...
if "เดือน" in df_pat.columns and "4 กลุ่มโรคเฝ้าระวัง" in df_pat.columns:
    # 'gp_list' จะไม่รวม 'ไม่จัดอยู่ใน 4 กลุ่มโรค' แล้ว เนื่องจากการกรองด้านบน
    ...
    # dff เป็นข้อมูลที่ถูกกรองตาม Sidebar filters (ใช้ใน Tab 4 และ Tab 5)
    dff = df_pat.copy()
...
with tab1:
    ...
    # แก้ไข: ใช้ df_pat แทน dff เพื่อให้กราฟหลักแสดงแนวโน้มทุกกลุ่มโรคเสมอ
    # ข้อมูล df_pat นี้ถูกกรอง "ไม่จัดอยู่ใน 4 กลุ่มโรค" ออกไปแล้ว
    plot_patient_vs_pm25(df_pat, df_pm) 
