...
if page_selection == "📈 Dashboard ปัจจุบัน":
    ...
    if len(df_analysis) < 3:
        ...
        **2. นิยามกลุ่มเปราะบาง (ตามเกณฑ์กระทรวงสาธารณสุข):**
        * **👶 เด็กเล็ก:** อายุ 0 - 5 ปี (ระบบภูมิคุ้มกันและปอดยังพัฒนาไม่เต็มที่)
        * **👵 ผู้สูงอายุ:** อายุ 60 ปีขึ้นไป (เสื่อมถอยตามวัยและมักมีโรคประจำตัว)
