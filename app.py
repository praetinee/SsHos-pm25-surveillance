...
# ----------------------------
# 🎛 Sidebar Placeholder (Removed Global Filters)
# ----------------------------
st.sidebar.header("🔍 ตัวกรองข้อมูล")
st.sidebar.info("ตัวกรองย้ายไปอยู่ในแท็บ 'Dashboard ปัจจุบัน' แล้ว เพื่อให้ง่ายต่อการใช้งาน")
...
with tab1:
    ...
    # --- Local Filter for Dashboard Tab ---
    ...
    # โค้ดนี้จะใช้ dff_tab1 ที่ถูกกรองตามตัวเลือกในแท็บนี้แล้ว
...
with tab4:
    ...
    # UPDATED: ใช้ df_pat (ข้อมูลทั้งหมด) แทนตัวแปร dff ที่ถูกลบไปแล้ว
...
with tab6:
    ...
    # Call the new function for J44.0 using the 'ICD10ทั้งหมด' column
    plot_specific_icd10_trend(
        df_pat=df_pat, 
        df_pm=df_pm, 
        icd10_code="J44.0", 
